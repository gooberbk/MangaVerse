      ...
      <div className="relative mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,280px)_1fr] lg:items-start lg:gap-12 xl:grid-cols-[minmax(0,320px)_1fr]">
          <div className="relative mx-auto w-full max-w-xs lg:mx-0 lg:max-w-none">
            <div
              className={cn(
                "relative aspect-[3/4] overflow-hidden rounded-2xl bg-gradient-to-br shadow-2xl shadow-purple-500/25 ring-1 ring-white/10",
                manga.coverGradient,
              )}
            >
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-muted">
              <span>
                Story by <span className="text-white">{manga.author}</span>
              </span>
              <span className="hidden text-white/20 sm:inline">|</span>
              <span>
                Art by <span className="text-white">{manga.artist}</span>
              </span>
            </div>
