...
export function AdminChapterEmptyState({
  onReset,
  message = "No chapters match your current filters. Try expanding your search or reset the filters to see all chapters.",
  actionLabel = "Reset Filters",
}: AdminChapterEmptyStateProps) {
  return (
    <div className="glass rounded-2xl p-12 text-center shadow-lg shadow-black/20">
      ...
      <p className="mb-6 text-muted max-w-sm mx-auto">{message}</p>
      {actionLabel && (
